...
var CandidateDetail = function (_BaseComponent) {
	_inherits(CandidateDetail, _BaseComponent);

	function CandidateDetail(props) {
		_classCallCheck(this, CandidateDetail);

		return _possibleConstructorReturn(this, (CandidateDetail.__proto__ || Object.getPrototypeOf(CandidateDetail)).call(this, props));
	}

	_createClass(CandidateDetail, [{
		key: 'render',
